...
int createSpiral(int &nPoints);
int createStar(int nPoints, float minRadius, float maxRadius);
...
//#endif
	...
	//Estrela
	int ePoints = 10;
	GLuint VAO2 = createStar(ePoints,0.2,0.5);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_LINE_LOOP, 1, ePoints);
